...
const int YY_parse_CLASS::multiplication=259;
const int YY_parse_CLASS::addition=260;
const int YY_parse_CLASS::openBR=261;
const int YY_parse_CLASS::closeBR=262;
...
static const char * const yytname[] = {   "$","error","$illegal.","id","multiplication",
"addition","openBR","closeBR","start","expr","term","factor",""
};
#endif
...
-32768,    -3,    -4,    -2,-32768,    -1,    -3,    -3,-32768,    -2,
-32768,     5,     7,-32768
};
